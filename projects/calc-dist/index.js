...
(function(window, createjs, opspark, gamz) {
   ...
   */
  bg.graphics.beginFill('grey').drawRect(500, 500, canvas.width, canvas.height);
  ...
  shapeOver.graphics.beginFill('black').drawCircle(0, 0, radius);
  shapeOver.alpha = 0;
   ...
   */
  const
    textfield = new createjs.Text('Distance: ', "20px Arial", "black"),
  ...
  function update(event) {
     ...
     */
        const mouse = { x: stage.mouseX, y: stage.mouseY}
