(function(window, createjs, opspark, _) {
  ...
  function update(event) {
    ...
    if(ball.x - ball.radius < paddlePlayer.x && ball.y > paddlePlayer.y && ball.y < paddlePlayer.y + paddlePlayer.height){ // Player Paddle
        ball.xVelocity = -ball.xVelocity
      }
      else if(ball.x + ball.radius > paddleCPU.x && ball.y > paddleCPU.y && ball.y < paddleCPU.y + paddleCPU.height){ // CPU Paddle
        ball.xVelocity = -ball.xVelocity
}
